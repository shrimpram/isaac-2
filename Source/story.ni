...
After reading a command:
	if the player's command matches "justify util":
		say "Ought is defined as consistency with function[line break]Macintyre 81[line break]from ‘He is a  captain’; the conclusion may be inferred ‘He ought to do whatever a -captain ought to do’. it shows a grammatical truth an ‘is’ premise can on occasion entail an ‘ought’ conclusion From ‘This watch is inaccurate the conclusion follows ‘This is a bad watch’. we define ‘watch’ in terms of function a watch cannot be defined independently of the concept of a good watch.[line break]And, the governments of states have a role to maximize public well being. Governments are limited by scarce resources which means they inevitably have to make decisions about who to serve. For example, the government can’t send one police car to two robberies at once so one gets prioritized which makes it responsible for omitting to rectify the violation—the only non-arbitrary way to make that decision is to value everyone equally and aggregate.[paragraph break]Thus, the standard is maximizing public well-being.";
		say "Even if ought is a question of morality prefer util.[line break]1. Morality is dependent on the actor, the most moral thing that governments can do is to maximize public well-being because[line break]	a) they can do that effectively with good policies[line break]	b) governments aren’t prepared to do other things AND it’s impossible to see the motivation behind every individual[line break]Goodin 95[line break]there is something special about the situation of public officials that makes utilitarianism more plausible for them Public officials are obliged to make their choices under uncertainty Public officials typically know averages and aggregates. They know what will happen most often to most people as a result of their various possible choices. That is enough to allow public policy makers to use the utilitarian calculus to choose general rules of conduct.[paragraph break]";
		say "2. Other frameworks can’t explain degrees of wrongness – only util explains why murder is worse than poking.[paragraph break]3. Pain and pleasure are intrinsically valuable so focusing on that means that we guarantee we’re doing good things.[paragraph break]4. Theoretical justifications determine the validity of substance and util is best[line break]	a) Ground – every impact functions under util whereas other ethics flow to one side exclusively. Kills fairness since we both need arguments to win and[line break]	b) Topic lit – most articles are written through the lens of util because they’re crafted for policymakers and the general public who take consequences to be important, not philosophy majors. Key to fairness and education – the lit is where we do research and determines how we engage in the round.[line break]	c) Education – phil isn’t applicable outside of debate and util is used all the time.[paragraph break]5. Debaters misinterpret phil and K lit all the time but util is simple and there’s a higher probability we’re arguing under the framework correctly and being moral.[paragraph break]6. Prioritize extinction because we can’t access future value under any framework without life.[paragraph break]";
		say "And the role of the judge is to affirm if the plan has good consequences and negate otherwise – anything else is self-serving and arbitrary. Evaluate the net consequences of the plan not everything the Kritik impacts out to or else neg can get infinite offense through claiming I resemble something violent.";
		reject the player's command.

	
After reading a command:
	if the player's command matches "pakistan terror":
		say "Warming causes internal Pakistan collapse creating an opening for nuclear theft.[line break]Klare 1-13[line break]extreme drought creating an opening for radical Islamists aligned with elements of the armed forces to seize some of the country’s 150 or so nuclear weapons. The risk to Pakistan from climate change is acute. landowners dominate politics climate change is bound to make the problem worse. Pakistanis expected to suffer a highly stressed environmental system on which a tense society depends can be a source of political instability and how that source can intensify when climate events put increased stress on the system[paragraph break]";
		say "The theft requires both motive and capability. Al-Qaeda has both.[line break]Hundley 18[line break]nuclear weapons will fall into the hands of terrorists. The weapons will be stored in Karachi or Balochistan al-Qaeda has shown a willingness and capability the ease with which the attackers entered and their focus suggested inside help.[paragraph break]";
		say "That causes US-Russia nuclear war.[line break]Barrett et al. 13[line break]War involving the U.S. and Russian nuclear arsenals the largest of any nations could lead to extinction Nuclear war including unauthorized launch safeguards over nuclear weapons fail they have remained ready to launch nuclear missiles terrorist groups  might cause attacks on either the US or Russia that resemble some kind of nuclear attack by the other nation by exploding a stolen bomb Al Qaeda has sought to obtain nuclear weapons and to use them against the US[paragraph break]";
		say "Using nukes means Earth explodes, causes extinction[line break]Chalko 03[line break]Consequences of using modern nuclear weapons can be far more serious neutron radiation reach significant depths in the planetary interior causes increased nuclear heat generation in the planetary interior The TRUE danger of modern nuclear weaponry is that their neutron radiation is capable to induce global overheating of the planetary interior cause the entire planet to explode";
		reject the player's command.

After reading a command:
	if the player's command matches "Baudrillard":
		say "God is dead but the hyperreal is alive and kicking. Our forms of information and communication are only signifiers – words are references to the real. Originally, the real thing created what references it, but Baudrillard indicates that in the age of mass media we no longer create signifiers to refer to reality, we create reality based on our signifiers. For example, Coca-cola is just another liquid but through our interpretation of it via ads and discourse we give it a brand and a certain legitimacy. Then, through a circular process, signs start to only signify other signs, not anything real, i.e. my interpretation of something will eventually be just based on your interpretation of it, which is based on someone else’s. Thus, the creation of meaning is no longer about real things but just an exchange of empty signifiers devoid of real meaning. This is the hyperreality and it neutralizes any truth in messages and medium. The hyperreal is fundamentally unstable because there is nothing behind it to support it -- it is supposed to implode from lack of power but it lives on meanings given to it by people who assume it has meaning. The explosive idealism of the 1AC prevents the coming implosion of hyperreality by giving meaning to the meaningless – only embracing the implosion can collapse the simulation.[paragraph break]";
		say "The 1AC’s revolutionary attempt to revive the university fails because their method of meaning production is already dead – their mythical nostalgia for a sense of justice keeps the already corrupted system alive. Only the alternative, by embracing the rotting of these institutions, can dissolve the system.[paragraph break]";
		say "The alternative is to recognize radical alterity – refusing to ascribe a fixed identity to the Other means the system cannot assimilate the Other[line break]That means order-driven solutions like the aff’s policy approach can’t solve – they paradoxically increase disorder in the system which causes their own impacts";
		reject the player's command.
	
After reading a command:
	if the player's command matches "Disclosure shell":
		say "Interpretation: Debaters must open source all cards read in their constructive speeches on their page of the HSLD wiki after each round with highlighting[paragraph break]";
		say "Violation: screenshot[paragraph break]";
		say "Standards:[line break]";
		say "1. Debate resource inequities – open source helps novices, independents, and lowly funded debaters. Stealing evidence is good. Big schools will backchannel ev anyways, all you do is hurt small schools. Resource inequities control how people engage in debate which is key to accessibility.[line break]Antonoucci 05[line break]Open source systems are preferable It's better to share the wealth open systems may be the only answer to resource inequities. Every other proposal fails open source would reduce entry barriers especially on the novice level the option can't hurt open source system would fundamentally change the evidence economy without targetting anyone[paragraph break]";
		say "2. Evidence ethics – Open source helps verify cards aren’t miscut. Prep time is not enough to actually check their sources. Ev ethics is a voter otherwise there would be no debate, just who can read the most miscut evidence. People get fired and expelled for this in the real world, it’s a good norm.[paragraph break]3. Clash – If debaters know what exactly their opponent reads and not just what the article says they’ll be able to better engage in the round. Key to education cuz we get more in-depth debate. [paragraph break]4. Wiki rules – it says you should open source, means this shell isn’t arbitrary and there IS a brightline for disclosure, no 'endless disclosure' args.[paragraph break]";
		say "5. Reciprocity – most debaters open source. My opponent gets access to cites and cards for cases and prep, which improves quality ground and means they can predict what other people are running, but we can’t predict them. This outweighs—a) every reason disclosure is good is an advantage for them and not me, view their counter-interp with a grain of salt since it’s self-serving. Reciprocity key to fairness—ensures equal access to the ballot.[paragraph break]";
		say "Voters:[line break]1. Fairness is a voter because debate is a competitive activity[line break]2. Education is a voter because it’s the reason schools fund debate, we wouldn’t have debate without it[line break]3. Accessibility is a voter and comes first since rejecting it is morally abhorrent and it’s a prereq to debate[paragraph break]Drop the debater[line break]1. Rectify time spent on theory[line break]2. Deter future abuse[paragraph break]Competing interps[line break]1. Reasonability is arbitrary and invites judge intervention[line break]2. Reasonability creates a race to the bottom where people try to find out how abusive they can be[paragraph break]No RVIs[line break]1. They’re illogical[line break]2. They chill abuse checking[line break]3. Incentivizes people to bait theory then win the RVI[line break]4. It is your responsibility to be fair and educational";
		reject the player's command.
